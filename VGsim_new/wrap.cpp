...
BOOST_PYTHON_MODULE( source_VGsim ) {
    class_<Simulator>( "Simulator" )
        .def( init<uint64_t,uint64_t,uint64_t,uint64_t,uint64_t>( args( "number_of_sites", "number_of_allele_states", "number_of_populations", "number_of_susceptible_groups", "seed" ) ) )
