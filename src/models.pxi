...
cdef class PopulationModel:
    cdef:
        ...
        double[::1] contactDensity, contactDensityBeforeLockdown, contactDensityAfterLockdown, startLD, endLD, samplingMultiplier, maxEffectiveMigration
        double[:,::1] migrationRates, effectiveMigration

    def __init__(self, popNum, susNum, hapNum):
        self.hapNum = hapNum
        self.popNum = popNum
        self.susNum = susNum
